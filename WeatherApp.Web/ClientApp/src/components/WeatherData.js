        ...
        return (
            ...
            <div>
              <div class="card"><div class="card-body">
                  ...
                  <h4 class="card-title">Weather: {weatherData.weather[0].main }</h4>

                  <h6 class="card-subtitle mb-2">Current temperature: <i>{weatherData.main.celsius_temp}</i> &#8451;</h6>
                  <p class="card-text">Feels Like: {weatherData.main.celsius_feels_like} &#8451;</p>
                  <p class="card-text">Max:  {weatherData.main.celsius_temp_max} &#8451;, Min: {weatherData.main.celsius_temp_min} &#8451;</p>
